...
normalized_data<-normalize(to_be_normalized, method = "scale", range = c(0, 1))
...
msse <- get_mse(xn)
write.csv(xn,'W:\\cases\\Question 2\\Feature scaling 1 center and scale\\Feature_scaling2_continuous.csv', row.names = TRUE)
write.table(msse, 'W:\\cases\\Question 2\\Feature scaling 1 center and scale\\Feature_scaling2_continuous.csv', col.names=FALSE, sep=",", append=TRUE)
