...
normalized_data<-normalize(to_be_normalized, method = "standardize", range = c(0, 1))
...
to_be_written<-rbind.fill(d, accu_d)
print(to_be_written)
print(paste("Accuracy is", accuracy(d)))
accu_d <- accuracy(d)
write.csv(d,'W:\\cases\\Question 2\\Feature scaling 1 center and scale\\MyData_catagorical.csv', row.names = TRUE)
write.table(accu_d, 'W:\\cases\\Question 2\\Feature scaling 1 center and scale\\MyData_catagorical.csv', col.names=FALSE, sep=",", append=TRUE)
